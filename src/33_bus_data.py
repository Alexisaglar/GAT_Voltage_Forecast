...
def extract_data_from_pandapower(net):
    # Extract line data (from_bus, to_bus, x, r, length)        line_data = self.net.line[['from_bus', 'to_bus', 'length_km', 'r_ohm_per_km', 'x_ohm_per_km']]
    line_data = np.array([net.line.from_bus.values,
