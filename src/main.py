...
def main():
    ...
    batch_size = 256 
    train_loader = DataLoader(list(zip(data_train, target_train)), batch_size=batch_size, shuffle=True, num_workers = 8)
    val_loader = DataLoader(list(zip(data_val, target_val)), batch_size=batch_size, shuffle=False, num_workers = 6)
    test_loader = DataLoader(list(zip(data_test, target_test)), batch_size=batch_size, shuffle=False, num_workers = 6)
